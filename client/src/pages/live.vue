<template>
  <div class="live">
    ...
    <div class="liveBody">
      <div class="livebox">
        <div class="liveboxNav">
          <h2 @click="gotoAll('allgoods','方抱枕')">
            方抱枕 / Throw Pillow
        ...
        <div class="imgbox">
          <ul class="imglist">
            <li v-for="item in liveGoods" :key="item._id">
              <img
    ...
    <div class="liveBody">
      <div class="livebox">
        <div class="boderTop"></div>
        <div class="liveboxNav">
          <h2 @click="gotoAll('allgoods','方帆布画')">
            方帆布画 / Wall Art
            <i class="el-icon-arrow-right"></i>
          </h2>
        </div>
    ...
    <div class="liveBody">
      <div class="livebox">
        <div class="boderTop"></div>
        <div class="liveboxNav">
          <h2 @click="gotoAll('allgoods','矩帆布画')">
            矩帆布画 / Wall Art
            <i class="el-icon-arrow-right"></i>
          </h2>
        </div>
    ...
    <div class="liveBody">
      <div class="livebox">
        <div class="boderTop"></div>
        <div class="liveboxNav">
          <h2 @click="gotoAll('allgoods','懒人沙发')">
            懒人沙发 /
            <i class="el-icon-arrow-right"></i>
          </h2>
        </div>
...
export default {
  ...
  async created() {
    ...
    this.cmirrorgoods = cmirrorData.data.data;
  },
  methods: {
    Hgoto(goods_id, path) {
...
.liveBody .livebox .liveboxNav {
  width: 100%;
}
.liveBody .livebox .liveboxNav h2 {
  font-size: 14px;
  width: 100%;
}
.liveBody .livebox .liveboxNav h2 i {
  float: right;
}
.liveBody .livebox .imgbox {
  width: 100%;
  padding: 0 0 10px;
}
.liveBody .livebox .imgbox .imglist {
  display: flex;
  flex-direction: row;
...
.liveBody .livebox .imgbox .imglist li {
  padding: 10px;
}
</style>